...
import { Settings, Shield, Database, Mail, Users, Key } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { AdminProtectedRoute } from '@/components/admin/AdminProtectedRoute';
import { ModuleAccessConfiguration } from '@/components/admin/backoffice/ModuleAccessConfiguration';
import { UserLimitsConfiguration } from '@/components/admin/backoffice/UserLimitsConfiguration';
        ...
        <div className="p-8">
          ...
          <Tabs defaultValue="system" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="modules">Accès Modules</TabsTrigger>
              <TabsTrigger value="users">Limites Utilisateurs</TabsTrigger>
