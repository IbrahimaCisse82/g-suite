      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Select value={formData.supplier_id} onValueChange={(value) => setFormData(prev => ({ ...prev, supplier_id: value }))}>
            ...
            <SelectContent>
              {contacts.filter(contact => contact.type === 'fournisseur' || contact.type === 'both').map((contact) => (
        ...
        <div className="space-y-2">
          <Label htmlFor="purchase_number">Numéro d'achat</Label>
          <Input
            id="purchase_number"
            value={formData.purchase_number}
            onChange={(e) => setFormData(prev => ({ ...prev, purchase_number: e.target.value }))}
